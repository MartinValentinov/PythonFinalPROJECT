...
class CaloriesCalculator(models.Model):
    kilometers_ran = models.DecimalField(max_digits=6, decimal_places=2, help_text='Kilometers ran')
    kilometers_walked = models.DecimalField(max_digits=6, decimal_places=2, help_text='Kilometers walked')